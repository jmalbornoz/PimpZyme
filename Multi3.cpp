// MULTI3.CPP
// Definicion de las funciones miembro de la clase MULTI3
...
void Multi3::setMulti(int Nsub, float v_d, float v_r, float S_05_d, float S_05_r, float ad, float ar, float m)
{
    float MM;
...
void Multi3::advanceMulti(int& nS, int& nP, int& nS_out, int& nP_out)
{ 
