// MULTI2.CPP
// Definicion de las funciones miembro de la clase MULTI2
...
void Multi2::setMulti(int Nsub, float v_d, float v_r, float S_05_d, float S_05_r, float ad, float ar, float m)
{
    float MM;
...
void Multi2::advanceMulti(int& nS, int& nP, int& nS_out, int& nP_out)
{ 
